...
\draw [connection]  (conv_b01_l03-east)    -- node {\midarrow} (conv_b02_l01-west);
...
\pic[shift={(1,0,0)}] at (conv_b02_l01-east) 
    {Box={
        name=relu_b02_l01,
        caption= ,
        xlabel={{16, }},
...
\pic[shift={(1,0,0)}] at (relu_b02_l01-east) 
    {Box={
        name=conv_b02_l02,
        caption= ,
        xlabel={{16, }},
...
\pic[shift={(1,0,0)}] at (conv_b02_l02-east) 
    {Box={
        name=relu_b02_l02,
        caption= ,
        xlabel={{16, }},
...
\pic[shift={(1,0,0)}] at (relu_b02_l02-east) 
    {Box={
        name=conv_b02_l03,
        caption= ,
        xlabel={{16, }},
...
\path (conv_b02_l01-southeast) -- (conv_b02_l01-northeast) coordinate[pos=1.25] (conv_b02_l01-top) ;
\path (conv_b02_l03-south)  -- (conv_b02_l03-north)  coordinate[pos=1.25] (conv_b02_l03-top) ;
\draw [copyconnection]  (conv_b02_l01-northeast)  
-- node {\copymidarrow}(conv_b02_l01-top)
-- node {\copymidarrow}(conv_b02_l03-top)
-- node {\copymidarrow} (conv_b02_l03-north);
